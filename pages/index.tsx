...
export default function Home(): JSX.Element {
  ...
  return (
    <div className="container">
      ...
      <Button appearance="primary" arrow="right" className="lol">Lol kek</Button>
      <Button appearance="ghost" arrow="down" className="lol">Lol kek</Button>
      ...
      <Tag size="s"  color="primary">tagi1</Tag>
      <Tag size="m" href="https://google.com" color="green">tagi1</Tag>
